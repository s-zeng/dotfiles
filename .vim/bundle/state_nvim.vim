...
autocmd dein-events InsertEnter * call dein#autoload#_on_event("InsertEnter", ['lexima.vim', 'deoplete.nvim', 'neco-syntax', 'neosnippet.vim', 'neosnippet-snippets', 'deoplete-jedi', 'clang_complete'])
